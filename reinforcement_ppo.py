...
from continuous import TanhNormal
...
# device = "cuda" if torch.cuda.is_available() and not is_fork else "cpu"
device = "cuda"
...
from torchrl.envs import UnsqueezeTransform, CatTensors
base_env = PendulumEnv(device=device)

td = base_env.reset()
# print("reset tensordict", td)

td = base_env.rand_step(td)
...
env_t.append_transform(t_sin)
env_t.append_transform(t_cos)
...
env_t.append_transform(cat_transform)
...
#
print("normalization constant shape:", env.transform[4].loc.shape)
